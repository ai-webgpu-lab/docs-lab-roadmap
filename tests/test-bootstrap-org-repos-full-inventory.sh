...
assert_contains "${TMP_DIR}/out/.github/README.md" "actions/workflows/operations-check.yml/badge.svg?branch=main"
assert_contains "${TMP_DIR}/out/.github/README.md" "docs-lab-roadmap/docs/WORKFLOW-STATUS.md"
assert_contains "${TMP_DIR}/out/.github/profile/README.md" "actions/workflows/operations-check.yml/badge.svg?branch=main"
assert_contains "${TMP_DIR}/out/.github/profile/README.md" "docs-lab-roadmap/docs/WORKFLOW-STATUS.md"
...
assert_contains "${TMP_DIR}/out/app-blackhole-observatory/.github/workflows/deploy-pages.yml" "actions/configure-pages@v6"
assert_contains "${TMP_DIR}/out/app-blackhole-observatory/.github/workflows/deploy-pages.yml" "actions/upload-pages-artifact@v5"
assert_contains "${TMP_DIR}/out/app-blackhole-observatory/.github/workflows/deploy-pages.yml" "actions/deploy-pages@v5"
assert_contains "${TMP_DIR}/out/app-blackhole-observatory/public/index.html" "Blackhole Observatory Demo"
assert_contains "${TMP_DIR}/out/app-blackhole-observatory/public/app.js" "blackhole-observatory-demo"
