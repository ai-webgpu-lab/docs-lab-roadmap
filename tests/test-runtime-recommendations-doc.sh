...
assert_contains "## \`bench-runtime-shootout\` Capture Protocol"
...
assert_contains "real-runtime-webgpu-cold.json"
assert_contains "real-runtime-fallback-warm.json"
assert_contains "validate-result-schema.mjs"
assert_contains "render-benchmark-summary.mjs"
