...
function buildResult() {
  ...
  return {
    meta: {
      ...
      owner: "ai-webgpu-lab",
      track: "blackhole",
      scenario: run ? "blackhole-three-singularity-readiness" : "blackhole-three-singularity-pending",
      notes: run
        ? `raySteps=${sceneConfig.raySteps}; diskSamples=${sceneConfig.diskSamples}; photonRingSamples=${sceneConfig.photonRingSamples}; backend=${state.environment.backend}; fallback=${state.environment.fallback_triggered}`
