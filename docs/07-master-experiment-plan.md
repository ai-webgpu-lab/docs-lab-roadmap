...
- 2026-04-22 기준 7개 주간 추적 workload 저장소는 headless Chromium baseline capture를 통해 첫 `reports/raw/*.json`, `reports/screenshots/*.png`, `reports/logs/*.log`, `RESULTS.md`를 보유한다
